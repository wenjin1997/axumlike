...
impl<H, B, T, F> OnMethod<H, B, T, F> {
    /// Chain an additional handler that will accept all requests regardless o f
    /// its HTTP method.
    ///
    ...
    /// Chain an additional handler that will accept `CONNECT` requests.
    ///
    /// See [`OnMethod::get`] for an example.
    ...
    /// Chain an additional handler that will accept `DELETE` requests.
    ///
    /// See [`OnMethod::get`] for an example.
    ...
    /// Chain an additional handler that will accept `GET` requests.
    ///
    // # Example
    //
    // ```rust
